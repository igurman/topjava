...
public class JdbcUserRepository implements UserRepository {
    ...
    public User get(int id) {
        ...
        return (users.size() > 0) ? addRoles(Objects.requireNonNull(DataAccessUtils.singleResult(users))) : null;
    }
    ...
    public List<User> getAll() {
        ...
        jdbcTemplate.query("SELECT * FROM user_roles", rs -> {
            roles.computeIfAbsent(rs.getInt("user_id"), k -> new HashSet<>()).add(Role.valueOf(rs.getString("role")));
        });
